...
if __name__ == '__main__':
    meta_path = RERANK_DIR + '../../candidate_patches/Defects4Jv1.2/meta.txt'
    
    quixbugs_meta = read_defects4j_meta(meta_path)
    model_id = 1
    # hypo_path_list = [RERANK_DIR + '../../data/patches/gpt_conut_3.txt'] + \
    #                  [RERANK_DIR + '../../data/patches/gpt_fconv_1.txt']
    # hypo_path_list = [RERANK_DIR + '..\\..\\data\\patches\\gpt_conut_{}_defects4jv2.0_parse.txt'.format(model_id)]
    # output_path = RERANK_DIR + '..\\..\\data\\patches\\reranked_patches_{}_defects4jv2.0_parse.json'.format(model_id)
    hypo_path_list = [RERANK_DIR + '..\\..\\data\\patches\\gpt_conut_{}_defects4jv1.2_parse.txt'.format(model_id)]
    output_path = RERANK_DIR + '..\\..\\data\\patches\\defects4jv1.2_reranked_patches_{}_parse.json'.format(model_id)
